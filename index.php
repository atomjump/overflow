		        ...
		        if(strpos($uc_message, "OVERFLOW") === 0) {
				      ...
				      if(is_numeric($new_max_messages)) {
				      	...
				      	if(($is_admin == true)||			//admin user
				    		...
				    		$new_message = "Sorry, you cannot decrease the maximum messages count, or above a maximum of " . $this->max_user_set_limit . " messages. You can contact your Admin user to request this change, however. " . $overflow_config ['contactAdminToRemoveLimits'];				    	
				    	}
				      } else {
